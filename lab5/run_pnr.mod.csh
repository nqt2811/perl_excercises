...
## project=   test              strategy=  perseus_default     
## design=    j2k_t1_wbuf_wrap_core strategy=  user_dt_r1s1d1p1_0613
## library=   test              strategy=  perseus_default_12T 
...
cd /asic/proj/red/test/build/silver001/j2k_t1_wbuf_wrap_core/user_dt_r1s1d1p1_0613/icc_pnr
\rm -rf log/run.log
echo submitting t131078_J1_ICC_FLOORPLAN_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613
setenv t131078_J1_ICC_FLOORPLAN_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=10G (FLOORPLAN) \
                        -o ./gridout \
                        -e ./griderr \
                        -m bes -M $RECIPIENT \
                        ...
                        -b y \
       source /asic/proj/uniquify/perseus/rel/modules/tcl/init/tcsh \&\& \
       source /tools/.cshrc.tools.train \&\& \
...
setenv t131079_J2_ICC_PLACE_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=11G (PLACE) \
...
setenv t131080_J3_ICC_CTS_CCD_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=12G (CTS_CCD) \
...
setenv t131081_J4_ICC_CTS_RT_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=13G (CTS_RT) \
...
setenv t131082_J5_ICC_ROUTE_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=14G (ROUTE) \
...
setenv t131083_J6_ICC_ROUTE_OPT_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=15G (ROUTE_OPT) \
...
setenv t131084_J7_ICC_CHIP_FINISH_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=16G (CHIP_FINISH) \
...
setenv t131085_J8_ICC_METAL_FILL_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=17G (METAL_FILL) \
...
setenv t131086_J9_ICC_EXPORT_j2k_t1_wbuf_wrap_core_user_dt_r1s1d1p1_0613 `qsub -V -terse -cwd -q test \
                        -l m_mem_free=18G (EXPORT) \
